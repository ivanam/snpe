ProyectoBase::Application.routes.draw do
  scope '/soft/snpe' do
   ...
   #get "altas_bajas_horas/modificar", to: 'altas_bajas_horas#modificar', as: :modificar_hs
    ...
    post "licencia/guardar_licencia_cargos/:id_cargos/:fecha_inicio(/:fecha_fin)/:articulo(/:fecha_anio_lic_1)(/:destino)", to: "licencia#guardar_licencia_cargos", as: :guardar_licencia_cargos
