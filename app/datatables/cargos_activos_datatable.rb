class CargosActivosDatatable < AjaxDatatablesRails::Base
  ...
  def data
    records.map do |record|
      [
        ...
        '<center><div class="btn-acciones"><a class="btn btn-primary btn-sm" id_cargos="'+record.id.to_s+'"href="'+Rails.application.routes.url_helpers.historial_agente_cargos_path(record.id.to_s)+'" title="Historial" ><span class=aria-hidden="true" >Historial</span></a>'
