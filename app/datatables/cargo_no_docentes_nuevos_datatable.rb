  ...
  def data
    records.map do |record|
      [
        ...
        '<a class="btn btn-danger btn-sm" rel="nofollow" data-method="delete" data-confirm="Seguro desea eliminar?" role="menuitem" tabindex="-1" href="cargo_no_docentes/'+record.id.to_s+'"><span class="glyphicon glyphicon-remove" aria-hidden="true" ></span></a>'+
