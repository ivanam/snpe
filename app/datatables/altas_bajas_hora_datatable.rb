class AltasBajasHoraDatatable < AjaxDatatablesRails::Base
  ...
  def sortable_columns
    @sortable_columns ||= ['Asistencium.id', 'Persona.nro_documento', 'Persona.apeynom','AltasBajasHora.fecha_alta','AltasBajasHora.fecha_baja','AltasBajasHora.situacion_revista','Establecimiento.localidad_id','AltasBajasHora.horas','AltasBajasHora.ciclo_carrera','AltasBajasHora.anio',
    'AltasBajasHora.division', 'AltasBajasHora.turno','AltasBajasHora.codificacion', ]
  end

  def searchable_columns
    @searchable_columns ||= ['Asistencium.id', 'Persona.nro_documento', 'Persona.apeynom','AltasBajasHora.fecha_alta','AltasBajasHora.fecha_baja','AltasBajasHora.situacion_revista','Establecimiento.localidad_id','AltasBajasHora.horas','AltasBajasHora.ciclo_carrera','AltasBajasHora.anio',
    'AltasBajasHora.division', 'AltasBajasHora.turno','AltasBajasHora.codificacion', ]
  end
