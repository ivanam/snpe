class ListadosLicenciaCargosnds2Datatable < AjaxDatatablesRails::Base
  ...
  def sortable_columns    
    ...
    @sortable_columns ||= ['Licencium.cargo_no_docente_id', 'CargoNoDocente.persona_id', 'Articulo.codigo', 'Licencium.fecha_desde', 'Licencium.fecha_hasta']
  end
  ...
  def searchable_columns
    ...
    @searchable_columns ||= ['Licencium.cargo_no_docente_id', 'CargoNoDocente.persona_id', 'Articulo.codigo', 'Licencium.fecha_desde', 'Licencium.fecha_hasta']
  end
