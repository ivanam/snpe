class ListadoParteDiarioDatatable < AjaxDatatablesRails::Base
  ...
  def sortable_columns    
    ...
    @sortable_columns ||= ['Persona.nro_documento','Persona.apeynom','Licencium.altas_bajas_hora_id', 'AltasBajasHora.persona_id', 'Articulo.codigo', 'Licencium.fecha_desde', 'Licencium.fecha_hasta']
  end
  ...
  def searchable_columns
    ...
    @searchable_columns ||= ['Persona.nro_documento','Persona.apeynom','Licencium.altas_bajas_hora_id', 'AltasBajasHora.persona_id', 'Articulo.codigo', 'Licencium.fecha_desde', 'Licencium.fecha_hasta']
  end
