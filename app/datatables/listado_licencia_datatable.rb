class ListadoLicenciaDatatable < AjaxDatatablesRails::Base
  ...
  def sortable_columns    
    ...
    @sortable_columns ||= ['Licencium.altas_bajas_hora_id', 'AltasBajasHora.persona_id', 'Articulo.codigo', 'Licencium.fecha_desde', 'Licencium.fecha_hasta']
  end
  ...
  def searchable_columns
    ...
    @searchable_columns ||= ['Licencium.altas_bajas_hora_id', 'AltasBajasHora.persona_id', 'Articulo.codigo', 'Licencium.fecha_desde', 'Licencium.fecha_hasta']
  end
