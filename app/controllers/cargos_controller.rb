class CargosController < ApplicationController
  ...
  def show
    ...
    @licencias = Licencium.where(:cargo_id => params[:id])
    ...
    respond_to do |format|
      ...
      format.pdf do
        ...
        :template => 'cargos/historial_pdf.html.erb',
  ...
  def dar_baja
    ...
    if @cargo.estado_actual == "Vacio" || @cargo.estado_actual == "Impreso" || @cargo.estado_actual == "Cobrado" || @cargo.estado_actual == "Cancelado_Baja"
      if @cargo.update(:fecha_baja => params[:input_fecha_baja], :motivo_baja => MotivoBaja.where(nro_motivo: params[:motivo_baja]).first)
