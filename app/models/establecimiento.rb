class Establecimiento < ActiveRecord::Base
  ...
  def horas_reubicacion
    return AltasBajasHora.where(establecimiento_id: self.id, estado: ['REU'] )
  end
  ...
  def self.estab_sedes
    return "(3000,3031,4002,4006,4001,4007,5009,4000,4004,4009,4012,4014,4015,4016,4017,4018,3004,9000,650)"
  end
