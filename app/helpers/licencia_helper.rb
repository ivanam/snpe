module LicenciaHelper
 ...
 #---------------------------------licencias sin goce ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	if current_user.role? :personal or current_user.role? :sadmin  or current_user.role? :licencia then
			...
			@licenciasCargSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargos.*, articulos.*').from('licencia, cargos, establecimientos, personas, articulos').where('licencia.cargo_id = cargos.id AND cargos.establecimiento_id = establecimientos.id AND cargos.persona_id = personas.id AND licencia.articulo_id = articulos.id').where('fecha_desde >= ?', mindate3).where('fecha_hasta <= ?', maxdate3).where('articulos.con_goce = 0')
			end
			if dni3 != nil and  art3 == nil
            @licenciasCargSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargos.*, articulos.*').from('licencia, cargos, establecimientos, personas, articulos').where('licencia.cargo_id = cargos.id AND cargos.establecimiento_id = establecimientos.id AND cargos.persona_id = personas.id AND licencia.articulo_id = articulos.id').where('fecha_desde >= ?', mindate3).where('fecha_hasta <= ?', maxdate3).where('articulos.con_goce = 0').where('nro_documento= ?', dni3)
            end
            if dni3 == nil and art3 != nil
            @licenciasCargSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargos.*, articulos.*').from('licencia, cargos, establecimientos, personas, articulos').where('licencia.cargo_id = cargos.id AND cargos.establecimiento_id = establecimientos.id AND cargos.persona_id = personas.id AND licencia.articulo_id = articulos.id').where('fecha_desde >= ?', mindate3).where('fecha_hasta <= ?', maxdate3).where('articulo_id = ?', art3)
		    end
		    if  dni3 != nil and art3 != nil
            @licenciasCargSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargos.*, articulos.*').from('licencia, cargos, establecimientos, personas, articulos').where('licencia.cargo_id = cargos.id AND cargos.establecimiento_id = establecimientos.id AND cargos.persona_id = personas.id AND licencia.articulo_id = articulos.id').where('fecha_desde >= ?', mindate3).where('fecha_hasta <= ?', maxdate3).where('articulo_id = ?', art3).where('nro_documento= ?', dni3)
		    end
		else
			if  dni3 == nil and  art3 == nil	
			@licenciasCargSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargos.*, articulos.*').from('licencia, cargos, establecimientos, personas, articulos').where('licencia.cargo_id = cargos.id AND cargos.establecimiento_id = establecimientos.id AND cargos.persona_id = personas.id AND licencia.articulo_id = articulos.id').where(cargos: {establecimiento_id: session[:establecimiento]}).where('fecha_desde >= ?', mindate3).where('fecha_hasta <= ?', maxdate3).where('articulos.con_goce = 0')
			end
			if dni3 != nil and  art3 == nil
            @licenciasCargSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargos.* , articulos.*').from('licencia, cargos, establecimientos, personas, articulos').where('licencia.cargo_id = cargos.id AND cargos.establecimiento_id = establecimientos.id AND cargos.persona_id = personas.id AND licencia.articulo_id = articulos.id').where(cargos: {establecimiento_id: session[:establecimiento]}).where('fecha_desde >= ?', mindate3).where('fecha_hasta <= ?', maxdate3).where('articulos.con_goce = 0').where('nro_documento= ?', dni3)
            end
            if dni3 == nil and art3 != nil
            @licenciasCargSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargos.*, articulos.*').from('licencia, cargos, establecimientos, personas, articulos').where('licencia.cargo_id = cargos.id AND cargos.establecimiento_id = establecimientos.id AND cargos.persona_id = personas.id AND licencia.articulo_id = articulos.id').where(cargos: {establecimiento_id: session[:establecimiento]}).where('fecha_desde >= ?', mindate3).where('fecha_hasta <= ?', maxdate3).where('articulo_id = ?', art3)
		    end
		    if  dni3 != nil and art3 != nil
            @licenciasCargSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargos.*, articulos.*').from('licencia, cargos, establecimientos, personas, articulos').where('licencia.cargo_id = cargos.id AND cargos.establecimiento_id = establecimientos.id AND cargos.persona_id = personas.id AND licencia.articulo_id = articulos.id').where(cargos: {establecimiento_id: session[:establecimiento]}).where('fecha_desde >= ?', mindate3).where('fecha_hasta <= ?', maxdate3).where('articulo_id = ?', art3).where('nro_documento= ?', dni3)
		    end
	end
	...
	def listado_de_licencias_cargonds_sg(mindate2, maxdate2, dni2, art2)
		if current_user.role? :personal or current_user.role? :sadmin  or current_user.role? :licencia then
			...
			@licenciasCndsSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargo_no_docentes.*, articulos.*').from('licencia, cargo_no_docentes, establecimientos, personas, articulos').where('licencia.cargo_no_docente_id = cargo_no_docentes.id AND cargo_no_docentes.establecimiento_id = establecimientos.id AND cargo_no_docentes.persona_id = personas.id AND licencia.articulo_id = articulos.id').where('fecha_desde >= ?', mindate2).where('fecha_hasta <= ?', maxdate2).where('articulos.con_goce = 0')
			end
			if dni2 != nil and  art2 == nil
            @licenciasCndsSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargo_no_docentes.*, articulos.*').from('licencia, cargo_no_docentes, establecimientos, personas, articulos').where('licencia.cargo_no_docente_id = cargo_no_docentes.id AND cargo_no_docentes.establecimiento_id = establecimientos.id AND cargo_no_docentes.persona_id = personas.id AND licencia.articulo_id = articulos.id').where('fecha_desde >= ?', mindate2).where('fecha_hasta <= ?', maxdate2).where('articulos.con_goce = 0').where('nro_documento= ?', dni2)
            end
            if dni2 == nil and art2 != nil
			...
			if dni2 != nil and  art2 == nil
            @licenciasCndsSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargo_no_docentes.*').from('licencia, cargo_no_docentes, establecimientos, personas').where('licencia.cargo_no_docente_id = cargo_no_docentes.id AND cargo_no_docentes.establecimiento_id = establecimientos.id AND cargo_no_docentes.persona_id = personas.id').where(cargo_no_docentes: {establecimiento_id: session[:establecimiento]}).where('fecha_desde >= ?', mindate2).where('fecha_hasta <= ?', maxdate2).where('con_goce = 0').where('nro_documento= ?', dni2)
            end
            if dni2 == nil and art2 != nil
            @licenciasCndsSg = Licencium.select('establecimientos.*, personas.*, licencia.*, cargo_no_docentes.*').from('licencia, cargo_no_docentes, establecimientos, personas').where('licencia.cargo_no_docente_id = cargo_no_docentes.id AND cargo_no_docentes.establecimiento_id = establecimientos.id AND cargo_no_docentes.persona_id = personas.id').where(cargo_no_docentes: {establecimiento_id: session[:establecimiento]}).where('fecha_desde >= ?', mindate2).where('fecha_hasta <= ?', maxdate2).where('articulo_id = ?', art2)
		    end
