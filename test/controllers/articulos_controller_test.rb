...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { cantidad_maxima_dias: @articulo.cantidad_maxima_dias, codigo: @articulo.codigo, descripcion: @articulo.descripcion }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { cantidad_maxima_dias: @articulo.cantidad_maxima_dias, codigo: @articulo.codigo, descripcion: @articulo.descripcion }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
